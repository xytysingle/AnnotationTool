...
@jsonModel()
class Bbox(object):
    def __init__(self, rectangle_id="",className="",color="",username=None,truncated=0,box=[],x1=0,y1=0,x2=0,y2=0,side_truncated=0,type_id="1",sceneType="-1",id="",check="False",score=0,type="0"):
        # self.__id=sku_name
