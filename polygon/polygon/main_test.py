...
# root_login = Tk()
# cv = Canvas(root_login,bg = 'white')
# # 创建两个rectangle
# rt1 = cv.create_rectangle(
#     10,10,110,110,
#     tags = ('r1','r2','r3'))
#
# img = Image.open(r"E:\Library\Pictures\1.jpg")
# img_size = img.size
# tk_img = ImageTk.PhotoImage(img)
# # cur_img_id = cv.create_image((0, 0), image=tk_img, anchor=N + W)
# # 将y坐标放大为原来的2位，x坐标值不变
# # cv.scale(rt1,10,10,1,2)
# cv.coords(rt1,(100,100,10,20))#scale的参数为(self,xoffset,yoffset,xscale,yscale)
...
path = StringVar()
path_for_jpg = "mark_samples/BBox-Label-Tool-master/Images/001/test.JPEG"
xialaliebiaozhi = []
im2 = PIL.Image.open("mark_samples/BBox-Label-Tool-master/Images/001/test.JPEG")
