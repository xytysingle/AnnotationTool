...
3. After finishing one image, click `Next` to advance. Likewise, click `Prev` to reverse. Or, input an image sku_name and click `Go` to navigate to the speficied image.
