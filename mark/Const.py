...
#View菜单选项子菜单
const.CN_VIEW_MENU_ITEMS ={'refresh':'刷新','pollmode':'轮询模式','autoLocation':'BBOX自动定位模式','toggleSKU':'切换SKU库','SKU':'饮料SKU库','SKU_MARS':'玛氏SKU库','SKU_MOUTH':'口腔清洁SKU库','linkage':'SKU-BBOX联动'}
const.EN_VIEW_MENU_ITEMS ={'refresh':'Refresh','pollmode':'Poll Mode','autoLocation':'Auto Location','toggleSKU':'Toggle SKU Lib','SKU':'Drink SKU Lib','SKU_MARS':'MARS SKU Lib','SKU_MOUTH':'SKU MOUTH','linkage':'SKU-BBOX Linkage'}
#Tools菜单选项子菜单
