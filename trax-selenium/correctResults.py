...
if __name__ == "__main__":
    ...
    all_data = read_json("danping20190313name.json")
    print(all_data)
    data = [{
		"className": "农夫山泉农夫果园芒果+菠萝+番石榴+苹果+番茄瓶装500毫升",
		"x1": 395,
		"y1": 275,
		"x2": 447,
		"y2": 437,
		"truncated": 0,
		"score": 0.99431496858597,
        "username": "tttt",
		"attribute": ""
	}, {
		"className": "青岛啤酒纯生玻璃瓶装500毫升",
		"x1": 195,
		"y1": 1009,
		"x2": 255,
		"y2": 1227,
		"truncated": 0,
		"score": 0.97377014160156,
        "username": "tttt",
		"attribute": ""
	}]
    for index in range(813051, 816101):
