...
Base_Path = "/Users/lingmou/Desktop/clusterData/"
...
def main():
    count = 0
    classimages = glob.glob(Base_Path + "processed/*/*.jpg")
    ...
    for classimage in tqdm(classimages):
        ...
        # x2 = int(results[4])
        # y2 = int(results[5])
        mkdir(Base_Path + "processed-2/" + classname)
        # for index in indexDatas:
        #     if index["old"] == original_img_name:
        #         count += 1
        shutil.copy(classimage, Base_Path + "processed-2/" + classname + "/{}_{}_{}_{}_{}_{}".format(results[1], results[2], results[3], results[4], results[5], results[6]))
    print("总处理数：",count)
