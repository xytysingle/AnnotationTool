...
def getAllJsonFile():
    global date
    global BasePath
    path = "{}OrginalImages/{}/*/*.json".format(BasePath, date)
...
# def getAllImgPath():
#     path = "/Users/lingmou/Desktop/trax-selenium/scence/20190315/*/*.jpeg"
...
if __name__ == "__main__":
    ...
    TargetPath = "/Users/lingmou/Desktop/traxResults/resultsJson/bottlesAndboxes/"
    date = "20190523"
    all_data = []
    # getOriginalPoints("/Users/lingmou/Desktop/python-script/trax-selenium/scence/20190313/9233287/9233287.json")
    getAllJsonFile()
    saveResultsByJson(TargetPath  + 'bottlesAndboxes_{}'.format(date), all_data)
    # getAllImgPath()